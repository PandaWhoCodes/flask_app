...
# words will be refined later- Basically are words like was and is ETC which are like fillers
...
# If your question mactes an existing question it will notify to avoid duplicates
# So what are we doing
# We are going to remove just the stop words and then match the words with other ones and create a score
# Something that google used to do looong back
# Can make this better- Somewhat like the amazon customer care guide which offeres suggestions
# can this be termed as machine learninh sir ??
